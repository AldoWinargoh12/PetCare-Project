                    ...
                    <div class="card wow fadeInRight" data-wow-delay="0.3s">
                      <div class="card-body">
                        ...
                        <div class="md-form">
                          ...
                          <input type="text" name="title" id="form3" class="white-text form-control" placeholder="Enter your title..." value="{{ old('title') }}">
                        </div>
                        <div class="md-form">
                          <i class="fas fa-envelope prefix white-text active"></i>
                          <label for="form2" class="active">Price (/day):</label>
                          <input type="text" name="price" id="form2" class="white-text form-control" placeholder="Enter your price..." value="{{ old('price') }}">
                        </div>
                        <div class="md-form">
                        <i class="fas fa-envelope prefix white-text active"></i>
                          <label for="form4">Location:</label>
                          <input  type="text" name="location" id="form4" class="white-text form-control" placeholder="Enter your location..." value="{{ old('location') }}">
                        </div>
                        <div class="md-form">
                        <i class="fas fa-envelope prefix white-text active"></i>
                          <label for="form4">Duration (/day):</label>
                          <input  type="text" name="duration" id="form4" class="white-text form-control" placeholder="Enter your location..." value="{{ old('duration') }}">
                        </div>
                        <div class="md-form">
                        <i class="fas fa-envelope prefix white-text active"></i>
                          <label for="form4">Starting Date:</label>
                          <input  type="date" name="startdate" id="form4" class="white-text form-control" placeholder="Enter your location..." value="{{ old('startdate') }}">
                        </div>
                        <div class="md-form">
                        <i class="fas fa-envelope prefix white-text active"></i>
                          <label for="form4">Description:</label>
                          <textarea type="text" style="height: 250px;" name="description" id="form5" class="white-text form-control" placeholder="Enter your description...">{{ old('description') }}</textarea>
                        </div>
