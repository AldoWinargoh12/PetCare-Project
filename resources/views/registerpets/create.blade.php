      ...
      <div class="form-group">
        <div class="card wow fadeInRight" data-wow-delay="0.3s">
          <div class="card-body">
            ...
            <div class="form-group">
            <label for="species" class="active">Pet Species/Breed:</label>
            ...
            <div class="md-form">
              ...
              <textarea style="height: 250px;" type="text" name="additional_notes" id="additional_notes" class="form-control">{{ old('additional_notes') }}</textarea>
            </div>
            </br>
